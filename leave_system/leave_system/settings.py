...
SECRET_KEY = 'django-insecure-@-&@+gj+v=1bugd71^%cw+b7py#fz55m62*gs+)yw62k%5r!5*'
...
INSTALLED_APPS = [
    ...
    'leave_management', # Added leave_management app
]
...
# Redirect URLs
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/accounts/login/' # Or any other page you prefer
